...
const GaugeChart = () => {
  ...
  useEffect(() => {
    ...
    const centerY = canvas.height - 140; // Slightly moved up
    const radius = 150; // Increase radius
    const gapSize = 0.08;
...
export default function Home() {
  ...
  return (
    <div className="bg-gradient-to-r from-[#E3E4FF] via-[#CDEAE6] to-[#FFF8D8] min-h-screen flex items-center justify-center p-6">
      {/* Navbar */}
    ...
    <div className="main-layout">
      ...
      />
      <div className="bg-gradient-to-r from-[#E3E4FF] via-[#CDEAE6] to-[#FFF8D8] shadow-lg rounded-lg p-6 w-full max-w-screen-lg">
        ...
        <div className="flex gap-12 mt-6">
          ...
          <div className="w-1/2 bg-white shadow-lg rounded-lg p-4">
            <h3 className="text-xl text-gray-800 font-bold text-center mb-4">Gauge Chart</h3>
            <GaugeChart />
          </div>

          {/* Bar Chart Card */}
          <div className="w-1/2 bg-white shadow-lg rounded-lg p-4">
            <h3 className="text-xl text-gray-800 font-bold text-center mb-4">Bar Chart</h3>
            <canvas ref={barChartRef} className="w-full h-full" width="450" height="300" />
          </div>
        </div>
